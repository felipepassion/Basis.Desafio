...
using Basis.Desafio.Core.Domain.Aggregates.CommonAgg.Repositories;
using Basis.Desafio.Core.Domain.Seedwork;
using Basis.Desafio.Core.Infra.Data.Contexts;
using Basis.Desafio.Core.Infra.Data.Extensions;
using System.Linq.Expressions;

namespace Basis.Desafio.Core.Infra.Data.Repositories
{

...
using Basis.Desafio.Livraria.Application.Aggregates.LivrariaAgg.AppServices;
using Basis.Desafio.Livraria.Infra.Data.Aggregates.LivrariaAgg.Repositories;
...
namespace Basis.Desafio.Livraria.Infra.IoC {

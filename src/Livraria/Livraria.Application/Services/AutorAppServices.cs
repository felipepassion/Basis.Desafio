...
namespace Basis.Desafio.Livraria.Application.Aggregates.LivrariaAgg.AppServices;
	...
	public partial class AutorAppService : BaseAppService, IAutorAppService {	
		...
		public AutorAppService(IMediator mediator, Basis.Desafio.CrossCutting.Infra.Log.Contexts.ILogRequestContext ctx, IAutorRepository autorRepository) : base(ctx, mediator) { _autorRepository = autorRepository; }	

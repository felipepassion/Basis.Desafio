...
namespace Basis.Desafio.Livraria.Application.Aggregates.LivrariaAgg.AppServices;
	...
	public partial class AssuntoAppService : BaseAppService, IAssuntoAppService {	
		...
		public AssuntoAppService(IMediator mediator, Basis.Desafio.CrossCutting.Infra.Log.Contexts.ILogRequestContext ctx, IAssuntoRepository assuntoRepository) : base(ctx, mediator) { _assuntoRepository = assuntoRepository; }	

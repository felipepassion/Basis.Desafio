...
namespace Basis.Desafio.Livraria.Application.Aggregates.LivrariaAgg.AppServices;
	...
	public partial class LivroAppService : BaseAppService, ILivroAppService {	
		...
		public LivroAppService(IMediator mediator, Basis.Desafio.CrossCutting.Infra.Log.Contexts.ILogRequestContext ctx, ILivroRepository livroRepository) : base(ctx, mediator) { _livroRepository = livroRepository; }	
